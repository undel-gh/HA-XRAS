...
В файле Kp дробный: `1.67`, `2.67`, `3.33`. Сайт в заголовке показывает
округлённое целое — `1.67` там отображается как «Kp = 2». Состояние сенсора —
точное дробное значение (так удобнее для автоматизаций и графиков), а
округлённое лежит в атрибуте `kp_display`.
